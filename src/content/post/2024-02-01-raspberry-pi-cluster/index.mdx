...
description: Building and configuring a Raspberry Pi cluster for distributed computing, including hardware setup, networking, and containerization with Docker.
tags:
  - Raspberry PI
  - Docker
  - Infrastructure
...
```
pi@pi-grey:~ $ ssh-keygen -t rsa -b 4096 -C "tim@pi-cluster"
